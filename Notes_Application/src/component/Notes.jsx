...
function Notes({ titletext, textareatext, onDelete }) {
  return (
   ...
   <div className="  wrap-break-word bg-white rounded-xl shadow-lg p-4 min-h-60 flex flex-col relative inset-shadow-sm inset-shadow-gray-500  hover:shadow-xl transition-shadow duration-200">
